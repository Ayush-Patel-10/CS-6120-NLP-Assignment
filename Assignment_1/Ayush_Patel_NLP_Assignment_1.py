...
def training(data, size, seed):
    df_upsampled = pre_process(data)
...
if __name__ == '__main__':
    ...
    while True:
        review = input("\n Review of the model, or press 'X' to quit. \n")
        if review.upper() == 'X':
           break
            ...
            if choice.upper() == 'X':
                ...
                if size.upper() == 'X':
                    ...
                    seed = input("\n Enter the random state of the new model: \n (Enter an integer as seed) \n (Press 'X' to quit.) \n")
                    ...
                    if seed.upper() == 'X':
                        ...
                        data = input("\n Upload the dataset at the same folder. \n  Or press 'Y' to use local dataset \n (Press 'X' to quit.) \n")
                        ...
                        if data.upper() == 'X':
                            ...
                            result, prob_list = training(data, size, seed)
                            Process_result(result, prob_list)
